...
//                 {!isSignIn && (<input type="text" placeholder="Enter a Name"  className="p-4 my-2 w-full bg-black border border-gray-400 rounded-lg"/>)}
...
//                 <p className="py-4 cursor-pointer" onClick={toggleSignIn}>{isSignIn ? "New to Netflix? Sign Up Now" : "Already a user Sign In Now"}</p>
//             </form>
//         </>
//     )
// }
